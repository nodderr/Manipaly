...
const CHANCE_CARDS = [
  ...
  { id: 'ch2',  text: 'Bhook lagi : Go to Adithya Mess.',                     action: 'move', destination: 16 },
  { id: 'ch3',  text: 'Exam Khatam : Move to Bachhus',                            action: 'move', destination: 26 },
  { id: 'ch4',  text: 'House Party : Go to D406 ',                              action: 'move', destination: 31 },
  { id: 'ch5',  text: "Matter Ho gaya : Go to Suresh",                  action: 'move', destination: 1 },
  ...
  { id: 'ch9',  text: 'Junior ko fake ganja bhej diya : Collect 150.',        action: 'collect', amount: 150 },
  { id: 'ch10', text: 'MES ke paise aa gaye : Collect 300.', action: 'collect', amount: 300 },
